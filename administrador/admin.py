...
#Parte inicial de la pagina donde iniciamos sesion como admin o usuario
@admin_bp.route('/', methods=['GET', 'POST'])
def inicio():
    mensaje = ''
    mensaje_tipo = ''
    
    #mensaje que se muestra luego de que un usuario se haya registrado correctamente
...
#En este apartado creamos un nuevo usuario
...
def registro():
    ...
    if request.method == 'POST':
        ...
        #se valida que el formato de DNI sea correcto
